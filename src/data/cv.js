export const CV = {
  ...
  tools: [
    ...
    "Redux Toolkit", "Zustand", "Context API", "Tailwind CSS", "SCSS",
    "Bootstrap", "Framer Motion", "Radix UI", "CSS Modules", "Figma",
    "Jest", "React Testing Library", "Webpack", "SSR", "SSG",
    "Git", "GitHub", "REST APIs", "PostgreSQL", "MongoDB", "SQL",
    "Postman", "Storybook",
  ],
